...
public class ManejadorVariablesProyectos {
    ...
    public static void main(String[] args) {
        Dao dao = new Dao();
        ManejadorVariablesProyectos m = new ManejadorVariablesProyectos(dao.getPryInd(37));
        ElementosVentas elemento = new ElementosVentas(m);
        
        elemento.getPorCre();
//        Double obtenerVariable = (Double) m.obtenerVariable("pry_orn");
//        Double d2=(Double) m.obtenerVariable("pry_cos_met");
//        System.out.println("la primera "+obtenerVariable);
//        System.out.println("la segunda "+d2);
//        m.guardarVariable("daniel", d2+obtenerVariable);
//        Double d3=(Double) m.obtenerVariable("daniel");
//        System.out.println("d3 es "+d3);
//        Object[] obtenerVariable1 = (Object[]) m.obtenerVariable("pry_edi_num_viv_eta");
//        System.out.println("el primero es "+(Double)obtenerVariable1[0]);
//        System.out.println("el segundo es "+obtenerVariable1[1]);
    }
}
